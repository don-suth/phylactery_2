...
class Item(models.Model):
	...
	slug = models.SlugField(
		max_length=100,
		help_text="An automatically generated, URL-safe title. Generally you don't edit these once the item is created."
	)
	
	# These fields are for the description, condition, and other notes.
	description = models.TextField(
		blank=True,
		help_text="A description of the item. Markdown enabled.",
	)
	condition = models.TextField(
		blank=True,
		help_text="A space for notes related to the condition of the item. Not displayed on the main item pages."
	)
	notes = models.TextField(
		blank=True,
		help_text="A space for misc. notes about the item. Displayed on the main item page."
	)
	...
	min_players = models.PositiveIntegerField(
		...
		help_text="The minimum number of players, usually for a board game."
	)
	max_players = models.PositiveIntegerField(
		blank=True, null=True,
		help_text="The maximum number of players, usually for a board game.",
	)
	...
	is_borrowable = models.BooleanField(
		default=True,
		help_text="Whether the item can be borrowed or not.",
	)
	is_high_demand = models.BooleanField(
		default=False,
		help_text="High-demand items can only be borrowed until the next weekday."
	)
